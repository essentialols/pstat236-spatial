...
sum(m >= ac) / 100
```
So again we see local spatial autocorrelation (Moran's I = `r ac`).  
...
# estimate error SAR model
col.errW.eig <- errorsarlm(HOVAL~INC+CRIME+OPEN+PLUMB, data=columbus.sf,
